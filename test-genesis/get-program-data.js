...
function get_program_data_address(mintAddress) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let data = Buffer.from(accountInfoJsonDump.account.data[0], accountInfoJsonDump.account.data[1]);
        let programDataAddress = new web3_js_1.PublicKey(data.subarray(4));
